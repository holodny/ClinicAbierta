...
namespace ClinicAbierta {
    ...
    public partial class OPENSIMDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/OPENSIMDataSet.xsd";
        ...
        public partial class CameraDataTable : global::System.Data.TypedTableBase<CameraRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CameraRow AddCameraRow(int camera_id, string stream, int panel) {
            ...
            private void InitClass() {
                ...
                this.columnstream.MaxLength = 180;
            }
...
namespace ClinicAbierta.OPENSIMDataSetTableAdapters {
    ...
    public partial class CameraTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Camera] WHERE (([camera_id] = @Original_camera_id) AND ((@IsNu" +
                "ll_stream = 1 AND [stream] IS NULL) OR ([stream] = @Original_stream)) AND ((@IsN" +
                "ull_panel = 1 AND [panel] IS NULL) OR ([panel] = @Original_panel)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Camera] ([camera_id], [stream], [panel]) VALUES (@camera_id, @" +
                "stream, @panel);\r\nSELECT camera_id, stream, panel FROM Camera WHERE (camera_id =" +
                " @camera_id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Camera] SET [camera_id] = @camera_id, [stream] = @stream, [panel] = @panel WHERE (([camera_id] = @Original_camera_id) AND ((@IsNull_stream = 1 AND [stream] IS NULL) OR ([stream] = @Original_stream)) AND ((@IsNull_panel = 1 AND [panel] IS NULL) OR ([panel] = @Original_panel)));
SELECT camera_id, stream, panel FROM Camera WHERE (camera_id = @camera_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT camera_id, stream, panel FROM dbo.Camera";
        ...
        public virtual int Delete(int Original_camera_id, string Original_stream, global::System.Nullable<int> Original_panel) {
        ...
        public virtual int Insert(int camera_id, string stream, global::System.Nullable<int> panel) {
        ...
        public virtual int Update(int camera_id, string stream, global::System.Nullable<int> panel, int Original_camera_id, string Original_stream, global::System.Nullable<int> Original_panel) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_camera_id));
            if ((Original_stream == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_stream));
            }
            if ((Original_panel.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_panel.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string stream, global::System.Nullable<int> panel, int Original_camera_id, string Original_stream, global::System.Nullable<int> Original_panel) {
            return this.Update(Original_camera_id, stream, panel, Original_camera_id, Original_stream, Original_panel);
        }
    }
